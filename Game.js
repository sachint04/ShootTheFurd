...
define(['three',
		...
		// 'PointerLockControls',
		'shell'
		], function(THREE,  MTLLoader, OBJLoader, Projector , Shell){
	...
	Game.prototype.setup 			= function(){
		...
		// prepare camera
		var VIEW_ANGLE 	= 80, ASPECT = this.SCREEN_WIDTH / this.SCREEN_HEIGHT, NEAR = 1, FAR = 20000;
...
//		Shell.log('this.renderer.domElement = '+ this.renderer.domElement);
	...
	//pointer.style.left = mouse
			...
			//console.log('this.renderer = '+this.renderer+' } this.controls.enabled = '+this.controls.enabled+' | scene = '+this.scene+ ' | this.camera = '+ this.camera);
