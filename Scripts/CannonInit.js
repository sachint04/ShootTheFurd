define(['cannon', 
		'shell'],
function(CANNON, Shell){
	
	
	var CannonSetup = function(){
		//Shell.log('Cannon setup '+ new CANNON());
		...
		this.getSphereBody = this.getSphereBody.bind(this);	
	};
	
	CannonSetup.prototype.init = function(){
		// Setup our world
		Shell.log('Cannon setup '+ CANNON);
	...
	CannonSetup.prototype.getSphereBody = function(){
